...
const countryListData: CountryData[] = [
  ...
  { company: "ANGLESEY", country: "İSVİÇRE", text: "Imp.By Ari's Wholesale LLC Prod.Date:AY/YIL Exp.Date:AY/YIL", note: "İSPANYOLCA ETİKET" },
  { company: "BINGO", country: "DUBAİ", text: "Uvoznik za BiH: Bingo d.o.o., ul.Bosanska poljana bb, 75000 Tuzla, Bosna i Hercegovina Prod.Date: & Exp.Date: GÜN/AY/YIL", note: "BOŞNAKÇA AMBALAJ/ETİKET" },
  ...
  { company: "FİMTAD", country: "İSVEÇ", text: "Marknadsförs av: Foodia Global AB Tel: 031-210642 www.foodiaglobal.com Prod.Date:GÜN/AY/Yil Exp.Date:Gün/Ay/Yıl", note: "İSVEÇÇE ETİKET" },
  { company: "FOODIA", country: "İSVEÇ", text: "Imp. By: Ftz Foods Ltd. CM20 2DR U.K. www.ftzfoods.com Best Before:GÜN/AY/YIL", note: "pH max 4,6 BESİN ÖĞESİ ETİKETİ" },
  ...
  { company: "JOHN PASCALIS", country: "İNGİLTERE", text: "Imp.By:John&Pascalis Ltd. 665 North Circular Road London NW2 7AX U.K. Best Before:GÜN/AY/YIL", note: "İNGİLİZCE AMBALAJ" },
